...
import { createSlug, debounce } from "@/lib/helper";
...
import { getCategoryIconById } from "@/lib/data";
...
export default function SearchLocationBar() {
  ...
  const { data: searchResults, loading: searchLoading } = useConvexQuery(
  ...
  return (
    <div className="flex items-center">
      ...
      <div className="relative flex w-full" ref={searchRef}>
        ...
        {/* Search Results */}
        {showSearchResults && (
          <div className="absolute top-full mt-2 md:w-[450px] w-96 bg-background border rounded-lg shadow-lg z-50 max-h-[400px] overflow-y-auto">
            {searchLoading ? (
