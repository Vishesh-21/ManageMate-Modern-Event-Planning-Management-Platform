...
import EventCard from "@/app/(public)/explore/_components/event-card";
...
export default function MyTicketsPage() {
  ...
  const { data: registrations, loading: isLoading } = useConvexQuery(
    api.registration.getMyRegistrations
  );

  const { mutate: cancelRegistration, loading: isCancelling } =
  ...
  return (
    <div className="min-h-screen py-8 px-4 md:mt-2 mt-12">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {upcomingTickets.map((registration) => (
                <EventCard
                  ...
                  action="ticket"
                  onEventClick={() => setSelectedTicket(registration)}
