...
const EventDetailPage = () => {
  ...
  const { data: event, loading: isLoading } = useConvexQuery(
  ...
  return (
    <div
      ...
      className="min-h-screen py-8 mt-8 md:-mt-16 lg:-mx-5"
    >
      <div className="max-w-7xl mx-auto md:px-6 px-2 py-4">
        {/* Event Title & Info */}
        <div className="mb-6 mt-8 relative">
          <Badge variant="ghost" className="mb-3 absolute -top-5 right-10">
        ...
        {/* Hero Image */}
        {event.coverImage && (
          <div className="relative h-[270px] md:h-[400px] rounded-2xl overflow-hidden mb-6">
            <Image
